...
outdir <- "./mr_results"
ids  <- c("ebi-a-GCST006414", "finngenR11")
labs <- c("A", "B")
...
save_panel <- function(fn, outfile, w, h){
  ...
  p2 <- mk(fn, ids[2]) + clean_theme + labs(tag="B", title="FinnGen R11 (55,853 cases)")
...
save_panel("scatter", "Figure1_scatter_R11_300dpi.tiff", 10, 5)
save_panel("forest",  "Figure2_forest_R11_300dpi.tiff", 12, 10)
save_panel("funnel",  "Figure3_funnel_R11_300dpi.tiff", 10, 5)
save_panel("loo",     "Figure4_loo_R11_300dpi.tiff", 12, 10)
